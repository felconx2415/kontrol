...
INSERT INTO "new_Solicitud" ("aprobadaEn", "aprobadorId", "brigadaId", "canceladaEn", "creadaEn", "editadaEn", "editadaPorId", "enGestionEn", "enviadaEn", "estado", "folio", "gestorId", "id", "justificacion", "motivoRechazo", "pedidoExternoRef", "recibidaEn", "solicitanteId", "tipo") SELECT "aprobadaEn", "aprobadorId", "brigadaId", "canceladaEn", "creadaEn", "editadaEn", "editadaPorId", "enGestionEn", "enviadaEn", "estado", "folio", "gestorId", "id", "justificacion", "motivoRechazo", "pedidoExternoRef", "recibidaEn", "solicitanteId", "tipo" FROM "Solicitud";
